...
const SignInPage = () => {
    return (
        <section className="w-full flex min-h-screen relative lg:bg-[url('src/assets/imgs/img_bg.svg')] bg-[url('src/assets/imgs/img_bgMobile.svg')] lg:bg-center  bg-cover bg-no-repeat ">
