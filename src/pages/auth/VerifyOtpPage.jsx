...
const VerifyOtpPage = () => {
    return (
        <section className="w-full flex min-h-screen relative bg-primaryGreen/40 lg:bg-[url('src/assets/imgs/img_bg.svg')] bg-[url('src/assets/imgs/img_bgMobile.svg')] lg:bg-center bg-cover bg-no-repeat ">
